...
import DefaultResourceService from '../services/ResourceServise';
import type { RegisterService } from '../services/RegisterService';
import DefaultRegisterService from '../services/RegisterService';
...
container.bind<RegisterService>(ownTypes.registerService).to(DefaultRegisterService).inSingletonScope();
